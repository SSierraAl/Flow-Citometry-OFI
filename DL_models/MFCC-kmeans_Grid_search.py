...
def evaluate_clustering_accuracy(n_mfcc, n_fft, hop_length, fmin, fmax, sample_rate=2000000):
    ...
    data_2um = extract_mfcc_features('D:/particles/2um_DB_Full', sample_rate, n_mfcc, n_fft, hop_length, fmin, fmax)
    data_4um = extract_mfcc_features('D:/particles/DB_4um', sample_rate, n_mfcc, n_fft, hop_length, fmin, fmax)
...
#Best Accuracy: 0.6371191135734072
#Best Parameters: {'n_mfcc': 40, 'n_fft': 1024, 'hop_length': 128, 'fmin': 7000, 'fmax': 35000}