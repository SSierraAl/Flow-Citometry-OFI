...
def extract_spectrogram_features(folder_path, sample_rate, display_min_freq, display_max_freq, nperseg, noverlap):
    ...
    for file_name in os.listdir(folder_path):
        ...
        filtered_signal = butter_bandpass_filter(signal, 8000, 40000, sample_rate)
...
def evaluate_clustering_accuracy(display_min_freq, display_max_freq, nperseg, noverlap, sample_rate=2000000):
    ...
    data_2um = extract_spectrogram_features('D:/particles/2um_DB', sample_rate, display_min_freq, display_max_freq, nperseg, noverlap)
    data_4um = extract_spectrogram_features('D:/particles/4um_DB', sample_rate, display_min_freq, display_max_freq, nperseg, noverlap)
    data_10um = extract_spectrogram_features('D:/particles/10um_DB', sample_rate, display_min_freq, display_max_freq, nperseg, noverlap)
...
display_min_freq_values = [8000, 10000, 12000]
display_max_freq_values = [30000, 35000, 40000]
